...
void dominioFrecuencial::leerCoefAC()
{
    ...
    bool parar=false;
    objNpad=new notepad();//Inicializar la clase notepad.
    QString fichero="C:\\Users\\FernandoAlexis\\Documents\\MATLAB\\golay\\golay\\for_testing\\limite.txt";
...
{
    QString fichero="C:\\Users\\FernandoAlexis\\Documents\\MATLAB\\golay\\golay\\for_testing\\codificado.txt";
    objNpad=new notepad();//Inicializar la clase notepad.
...
{
    objNpad=new notepad();//Inicializar la clase notepad.
    QString fichero="C:\\Users\\FernandoAlexis\\Documents\\MATLAB\\golay\\golay\\for_testing\\decodificado.txt";
