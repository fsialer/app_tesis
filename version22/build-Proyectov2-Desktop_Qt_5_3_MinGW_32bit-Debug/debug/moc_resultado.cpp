...
#include "../../Proyectov2/resultado.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_resultado_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "resultado\0on_pbtnProcesar_clicked\0"
};
...
void resultado::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_pbtnProcesar_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject resultado::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_resultado.data,
      qt_meta_data_resultado,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_resultado.stringdata))
